...
void loop() {
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    pixels.setPixelColor(i, pixels.Color(250,250,250)); // RED OFF.
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(250,250,250)); // GREEN OFF
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(250,250,250)); // BLUE OFF
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(0,0,250)); // BLUE
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(250,250,250)); // PURP OFF
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(138,43,226)); // PURP
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(250,250,250)); // YELL OFF
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(250,250,250)); // ORANGE
 ...
 for(int i=0;i<NUMPIXELS;i++){
    ...
    // pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels.setPixelColor(i, pixels.Color(255,140,0)); // ORANG
